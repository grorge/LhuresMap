								...
								if (checkChar == 'K')
								{
									...
									if (checkChar == 'd')
									{
										...
										if (!alreadyLoaded)
										{
											...
											hr = CreateWICTextureFromFile(Locator::getD3D()->GETgDevice(), fileNamePath.c_str(), nullptr, &tempMeshSRV);
											//hr = D3D11CreateShaderResourceViewFromFile(d3d11Device, fileNamePath.c_str(),
